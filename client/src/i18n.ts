        ...
        resources: {
            en: {
                translation: {
                    ...
                    cancel: 'Cancel',
                    paypalConfigError: 'PayPal payment is not available',
                },
            },
            pl: {
                translation: {
                    ...
                    payment: 'Płatność PayPal',
                    totalAmount: 'Suma',
                    paymentSuccessful: 'Płatność zakończona sukcesem!',
                    paymentFailed: 'Płatność nie powiodła się. Proszę spróbować ponownie.',
                    cancel: 'Anuluj',
                    paypalConfigError: 'Płatność PayPal jest niedostępna',
                },
            },
        },
        lng: 'pl',
